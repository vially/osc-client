...
var OscClient = function (domainArg, portArg, fetchClient) {
  'use strict'
  var domain = domainArg || 'localhost'
  var port = portArg || 8000

  this.serverAddress = 'http://' + domain + ':' + port
  this.fetchClient = fetchClient || crossFetch
  ...
  this.getInfo = function () {
    return makeHttpRequest(this.fetchClient, 'GET', infoUrl, this.applicationJsonType)
  }
  ...
  this.getState = function () {
    return makeHttpRequest(this.fetchClient, 'POST', stateUrl, this.applicationJsonType)
  }
  ...
  this.checkForUpdates = function (stateFingerprint, waitTimeout) {
    return makeHttpRequest(this.fetchClient, 'POST', checkForUpdatesUrl, this.applicationJsonType, {
  ...
  this.commandsStatus = function (commandId) {
    return makeHttpRequest(this.fetchClient, 'POST', commandsStatusUrl, this.applicationJsonType, { id: commandId })
  }
}
